...
<html>
  <head>
    ...
    <link rel="apple-touch-icon-precomposed" href="<%=basePath%>jsp/assets/i/app-icon72x72@2x.png">
    <meta name="apple-mobile-web-app-title" content="Amaze UI" />
    <link rel="stylesheet" href="<%=basePath%>jsp/assets/css/amazeui.min.css" />
    <link rel="stylesheet" href="<%=basePath%>jsp/assets/css/admin.css">
    <link rel="stylesheet" href="<%=basePath%>jsp/assets/css/app.css">
    <script src="<%=basePath%>jsp/assets/js/echarts.min.js"></script>
</head>
...
<body data-type="index">
    ...
    <header class="am-topbar am-topbar-inverse admin-header">
        <div class="am-topbar-brand">
            <a href="javascript:;" class="tpl-logo">
                <img src="<%=basePath%>jsp/assets/img/logo.jpg" alt="">
            </a>
        </div>
        ...
        <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                        <span class="tpl-header-list-user-nick">禁言小张</span><span class="tpl-header-list-user-ico"> <img src="<%=basePath%>jsp/assets/img/user01.png"></span>
                    </a>
                        ...
                        <div class="tpl-scrollable">
                            ...
                            <table class="am-table tpl-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>jsp/assets/img/user01.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>jsp/assets/img/user02.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>jsp/assets/img/user03.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>jsp/assets/img/user04.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>jsp/assets/img/user05.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>jsp/assets/img/user06.png" alt="" class="user-pic">
    ...
    <script src="<%=basePath%>jsp/assets/js/amazeui.min.js"></script>
    <script src="<%=basePath%>jsp/assets/js/iscroll.js"></script>
    <script src="<%=basePath%>jsp/assets/js/app.js"></script>
</body>
